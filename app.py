...
# Known service rating columns in the Airline Satisfaction dataset
...
# Small helper to build dropdown options
opt = (
    lambda s: [
                        ...
                        dbc.CardBody(
                            [
                                ...
                                html.Div(
                                    ...
                                    className="mt-0",  # alineado a la izquierda por defecto
                                ),
...
def update_dashboard(n_clicks, gender, customer, travel, cls, age, distance):
    ...
    return f"{sat_rate}%", f"{dissat_rate}%", pie_fig, bar_fig
